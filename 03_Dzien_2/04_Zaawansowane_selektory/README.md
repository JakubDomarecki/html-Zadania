...
>
> - `03_Dzien_2/04_Zaawansowane_selektory/01_Zadanie_1`
>
...
Wynik powinien być jak na poniższej grafice: ![](images/menu.png)
...
> Zmodyfikuj plik `vite.config.js` tak, aby zmienna `exercisePath` wskazywała na:
>
> - `03_Dzien_2/04_Zaawansowane_selektory/02_Zadanie_2`
>
> **Pamiętaj aby włączyć serwer deweloperski (`npm run dev`).**
...
> Zmodyfikuj plik `vite.config.js` tak, aby zmienna `exercisePath` wskazywała na:
>
> - `03_Dzien_2/04_Zaawansowane_selektory/03_Zadanie_3`
>
> **Pamiętaj aby włączyć serwer deweloperski (`npm run dev`).**
...
> Zmodyfikuj plik `vite.config.js` tak, aby zmienna `exercisePath` wskazywała na:
>
> - `03_Dzien_2/04_Zaawansowane_selektory/04_Zadanie_4`
>
> **Pamiętaj aby włączyć serwer deweloperski (`npm run dev`).**
...
W zadaniu **nie wolno używać klas i identyfikatorów**. Cała reszta jest dowolna. Liczy się efekt. W tym zadaniu bardzo dobrze jest posiłkować się debuggerem, dzięki czemu będziesz mógł sprawdzić jakiego typu jest dany kwadracik.
